    ...
    namespace MidiParse{
        ...
        class NotePair:public Note{
            public:
                ...
                double beat_diff;
            public:
                NotePair(MidiTime _time=0,MidiTime _duration=0,MidiTimeMode _timeMode=MidiTimeMode::tick,MidiTrackNum _track=0,MidiChannelNum _channel=0,uint8_t _pitch=0,uint8_t _velocity=0,uint8_t _instrument=0,double _bar=0,double _bar_diff=0,double _beat=0,double _beat_diff=0);
