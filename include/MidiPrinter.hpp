...
public:
    MidiPrinter(void)
        : m_file(stdout),
          m_format(MidiPrintFormat::table),
          m_jsonFormat(MidiPrintJsonFormat::jsonFormat_default),
          m_formatChar{FormatChar::tableChar_default, FormatChar::jsonChar_default} {
    }
...
private:
    void print_table_without_lable(const Note& a, FormatChar formatChar = FormatChar::tableChar_default) {
        ...
        fprintf(m_file, "%llu%c0x%2.2X%c0x%2.2X%c0x%2.2X%c0x%2.2X%c0x%2.2X%c%.4f%c%.4f%c", a.time, stepC, a.track,
                stepC, a.channel, stepC, a.instrument, stepC, a.pitch, stepC, a.velocity, stepC, a.bar, stepC, a.beat,
                endC);
    }
    void print_table_without_lable(const NotePair& a, FormatChar formatChar = FormatChar::tableChar_default) {
        ...
        char stepC = (formatChar & FormatChar::stepChar_space ? ' ' : '\t');
        char endC = (formatChar & FormatChar::endChar_comma ? ',' : '\n');
        fprintf(m_file, "%llu%c%llu%c0x%2.2X%c0x%2.2X%c0x%2.2X%c0x%2.2X%c0x%2.2X%c%.4f%c%.4f%c%.4f%c%.4f%c", a.time,
                stepC, a.duration, stepC, a.track, stepC, a.channel, stepC, a.instrument, stepC, a.pitch, stepC,
                a.velocity, stepC, a.bar, stepC, a.bar_diff, stepC, a.beat, stepC, a.beat_diff, endC);
    }
    void print_table_without_lable(const Tempo& a, FormatChar formatChar = FormatChar::tableChar_default) {
        ...
        char stepC = (formatChar & FormatChar::stepChar_space ? ' ' : '\t');
        char endC = (formatChar & FormatChar::endChar_comma ? ',' : '\n');
        fprintf(m_file, "%llu%c%llu%c%lu%c%.4f%c", a.tick(), stepC, a.microsecond(), stepC, a.mispqn, stepC, a.bpm(),
                endC);
    }
    void print_table_without_lable(const BarBeat& a, FormatChar formatChar = FormatChar::tableChar_default) {
        ...
        char stepC = (formatChar & FormatChar::stepChar_space ? ' ' : '\t');
        char endC = (formatChar & FormatChar::endChar_comma ? ',' : '\n');
        fprintf(m_file, "%llu%c%.4f%c%.4f%c%llu%c%llu%c", a.time, stepC, a.barNode, stepC, a.beatNode, stepC,
                a.numerator, stepC, a.denominator, endC);
    }
    void print_table_without_lable(const Text& a, FormatChar formatChar = FormatChar::tableChar_default) {
        ...
        char stepC = (formatChar & FormatChar::stepChar_space ? ' ' : '\t');
        char endC = (formatChar & FormatChar::endChar_comma ? ',' : '\n');
        fprintf(m_file, "%llu%c\"%s\"%c\"%s\"%c", a.time, stepC, Text::get_typeName(a.type).c_str(), stepC,
                a.text.c_str(), endC);
    }
    void print_table_without_lable(const MidiEvent& a, FormatChar formatChar = FormatChar::tableChar_default) {
        ...
        char stepC = (formatChar & FormatChar::stepChar_space ? ' ' : '\t');
        char endC = (formatChar & FormatChar::endChar_comma ? ',' : '\n');
        fprintf(m_file, "%llu%c%2.2X%c", a.time, stepC, a.track, stepC);
    ...
    void print_lable(const Note& a, FormatChar formatChar = FormatChar::tableChar_default) {
        ...
        fprintf(m_file, "%s%ctrack%cchannel%cinstrument%cpitch%cvelocity%cbar%cbeat%c",
                a.timeMode == MidiTimeMode::tick ? "tick" : "microsecond", stepC, stepC, stepC, stepC, stepC, stepC,
                stepC, endC);
    }
    ...
    void print_lable(const Tempo& a, FormatChar formatChar = FormatChar::tableChar_default) {
        ...
        char stepC = (formatChar & FormatChar::stepChar_space ? ' ' : '\t');
        char endC = (formatChar & FormatChar::endChar_comma ? ',' : '\n');
        fprintf(m_file, "tick%cmicrosecond%cmicrosecond_per_quarter_note%cbpm%c", stepC, stepC, stepC, endC);
    }
    void print_lable(const BarBeat& a, FormatChar formatChar = FormatChar::tableChar_default) {
        ...
        fprintf(m_file, "%s%cbar%cbeat%cnumerator%cdenominator%c",
                a.timeMode == MidiTimeMode::tick ? "tick" : "microsecond", stepC, stepC, stepC, stepC, endC);
    }
    void print_lable(const Text& a, FormatChar formatChar = FormatChar::tableChar_default) {
        ...
        char stepC = (formatChar & FormatChar::stepChar_space ? ' ' : '\t');
        char endC = (formatChar & FormatChar::endChar_comma ? ',' : '\n');
        fprintf(m_file, "%s%ctype%ctext%c", a.timeMode == MidiTimeMode::tick ? "tick" : "microsecond", stepC, stepC,
                endC);
    }
    void print_lable(const MidiEvent& a, FormatChar formatChar = FormatChar::tableChar_default) {
        ...
        char stepC = (formatChar & FormatChar::stepChar_space ? ' ' : '\t');
        char endC = (formatChar & FormatChar::endChar_comma ? ',' : '\n');
        fprintf(m_file, "%s%ctrack%cmessage%c", a.timeMode == MidiTimeMode::tick ? "tick" : "microsecond", stepC, stepC,
                endC);
    }
    ...
    void print_json_minimal(const Note& a, size_t index = (size_t)-1,
                            MidiPrintJsonFormat jsonFormat = MidiPrintJsonFormat::jsonFormat_default) {
        ...
        fprintf(m_file,
                "{\"track\":\"0x%2.2X\",\"channel\":\"0x%2.2X\",\"%s\":%llu,\"instrument\":\"0x%2.2X\",\"pitch\":\"0x%"
                "2."
                "2X\",\"velocity\":\"0x%2.2X\",\"bar\":%.4f,\"beat\":%.4f}",
                a.track, a.channel, a.timeMode == MidiTimeMode::tick ? "tick" : "microsecond", a.time, a.instrument,
                a.pitch, a.velocity, a.bar, a.beat);
        if (jsonFormat & MidiPrintJsonFormat::jsonFormat_file) {
            fprintf(m_file, "}");
        }
    }
    void print_json_minimal(const NotePair& a, size_t index = (size_t)-1,
                            MidiPrintJsonFormat jsonFormat = MidiPrintJsonFormat::jsonFormat_default) {
        if (jsonFormat & MidiPrintJsonFormat::jsonFormat_file) {
            fprintf(m_file, "{");
        }
        ...
        fprintf(m_file,
                "{\"track\":\"0x%2.2X\",\"channel\":\"0x%2.2X\",\"%s\":%llu,\"duration\":%llu,\"instrument\":\"0x%2."
                "2X\","
                "\"pitch\":\"0x%2.2X\",\"velocity\":\"0x%2.2X\",\"bar\":%.4f,\"bar_diff\":%.4f,\"beat\":%.4f,\"beat_"
                "diff\":"
                "%.4f}",
                a.track, a.channel, a.timeMode == MidiTimeMode::tick ? "tick" : "microsecond", a.time, a.duration,
                a.instrument, a.pitch, a.velocity, a.bar, a.bar_diff, a.beat, a.beat_diff);
        if (jsonFormat & MidiPrintJsonFormat::jsonFormat_file) {
            fprintf(m_file, "}");
        }
    }
    void print_json_minimal(const Tempo& a, size_t index = (size_t)-1,
                            MidiPrintJsonFormat jsonFormat = MidiPrintJsonFormat::jsonFormat_default) {
        if (jsonFormat & MidiPrintJsonFormat::jsonFormat_file) {
            fprintf(m_file, "{");
        }
        ...
        fprintf(m_file,
                "{\"track\":\"0x%2.2X\",\"tick\":%llu,\"microsecond\":%llu,\"microsecond_per_quarter_note\":%lu,"
                "\"bpm\":%."
                "4f}",
                a.track, a.tick(), a.microsecond(), a.mispqn, a.bpm());
        if (jsonFormat & MidiPrintJsonFormat::jsonFormat_file) {
            fprintf(m_file, "}");
        }
    }
    void print_json_minimal(const BarBeat& a, size_t index = (size_t)-1,
                            MidiPrintJsonFormat jsonFormat = MidiPrintJsonFormat::jsonFormat_default) {
        if (jsonFormat & MidiPrintJsonFormat::jsonFormat_file) {
            fprintf(m_file, "{");
        }
        ...
        fprintf(m_file,
                "{\"track\":\"0x%2.2X\",\"%s\":%llu,\"bar\":%llu,\"beat\":%llu,\"numerator\":%llu,\"denominator\":%"
                "llu}",
                a.track, a.timeMode == MidiTimeMode::tick ? "tick" : "microsecond", a.time, a.barNode, a.beatNode,
                a.numerator, a.denominator);
    }
    void print_json_minimal(const Text& a, size_t index = (size_t)-1,
                            MidiPrintJsonFormat jsonFormat = MidiPrintJsonFormat::jsonFormat_default) {
        if (jsonFormat & MidiPrintJsonFormat::jsonFormat_file) {
            fprintf(m_file, "{");
        }
        ...
        fprintf(m_file, "{\"track\":\"0x%2.2X\",\"%s\":%llu,\"type\":\"%s\",\"text\":\"%s\"}", a.track,
                a.timeMode == MidiTimeMode::tick ? "tick" : "microsecond", a.time, Text::get_typeName(a.type).c_str(),
                a.text.c_str());
        if (jsonFormat & MidiPrintJsonFormat::jsonFormat_file) {
            fprintf(m_file, "}");
        }
    }
    void print_json_minimal(const MidiEvent& a, size_t index = (size_t)-1,
                            MidiPrintJsonFormat jsonFormat = MidiPrintJsonFormat::jsonFormat_default) {
        if (jsonFormat & MidiPrintJsonFormat::jsonFormat_file) {
            fprintf(m_file, "{");
        }
        ...
        fprintf(m_file, "{\"track\":\"0x%2.2X\",\"%s\":%llu,\"message\":[", a.track,
    ...
    void print_json_minimal(const MidiEventList<_MidiEvent>& _list, size_t index, MidiPrintJsonFormat jsonFormat) {
        ...
        if (_list.size()) {
            for (size_t i = 0; i < _list.size() - 1; ++i) {
                print_json_minimal(_list[i], i,
                                   MidiPrintJsonFormat(jsonFormat & (~MidiPrintJsonFormat::jsonFormat_file) |
                                                       MidiPrintJsonFormat::jsonFormat_object));
                fprintf(m_file, ",");
            }
            print_json_minimal(_list.back(), _list.size() - 1,
                               MidiPrintJsonFormat(jsonFormat & (~MidiPrintJsonFormat::jsonFormat_file) |
                                                   MidiPrintJsonFormat::jsonFormat_object));
        }
        fprintf(m_file, "}");
    ...
    void print_json_minimal(const MidiEventMap<_MidiEvent>& _map, size_t index, MidiPrintJsonFormat jsonFormat) {
        ...
        if (_map.size()) {
            for (size_t i = 0; i < _map.size() - 1; ++i) {
                print_json_minimal(_map[i], i,
                                   MidiPrintJsonFormat(jsonFormat & (~MidiPrintJsonFormat::jsonFormat_file) |
                                                       MidiPrintJsonFormat::jsonFormat_object));
                fprintf(m_file, ",");
            }
            print_json_minimal(_map.back(), _map.size() - 1,
                               MidiPrintJsonFormat(jsonFormat & (~MidiPrintJsonFormat::jsonFormat_file) |
                                                   MidiPrintJsonFormat::jsonFormat_object));
        }
        fprintf(m_file, "}");
    ...
    void print_json_minimal(const MidiParser& _parser, size_t index = (size_t)-1,
                            MidiPrintJsonFormat jsonFormat = MidiPrintJsonFormat::jsonFormat_default) {
        if (jsonFormat & MidiPrintJsonFormat::jsonFormat_file) {
            fprintf(m_file, "{");
        }
        ...
        print_json_minimal(_parser.noteMap, 0,
                           MidiPrintJsonFormat(jsonFormat & (~MidiPrintJsonFormat::jsonFormat_file) |
                                               MidiPrintJsonFormat::jsonFormat_object));
        fprintf(m_file, ",");
        print_json_minimal(_parser.tempoMap, 1,
                           MidiPrintJsonFormat(jsonFormat & (~MidiPrintJsonFormat::jsonFormat_file) |
                                               MidiPrintJsonFormat::jsonFormat_object));
        fprintf(m_file, ",");
        print_json_minimal(_parser.bbMap, 2,
                           MidiPrintJsonFormat(jsonFormat & (~MidiPrintJsonFormat::jsonFormat_file) |
                                               MidiPrintJsonFormat::jsonFormat_object));
        fprintf(m_file, ",");
        print_json_minimal(_parser.textMap, 3,
                           MidiPrintJsonFormat(jsonFormat & (~MidiPrintJsonFormat::jsonFormat_file) |
                                               MidiPrintJsonFormat::jsonFormat_object));
        if (jsonFormat & MidiPrintJsonFormat::jsonFormat_file) {
            fprintf(m_file, "}");
    ...
    template <typename... Args>
    void print_json_pretty_newline_without_enter(const char* indentStr, size_t indent, const char* _format,
                                                 Args&&... args) {
        for (size_t i = 0; i < indent; ++i) {
            fprintf(m_file, indentStr);
        }
    ...
    void print_json_pretty(const Note& a, size_t index = (size_t)-1, size_t indent = 0,
                           FormatChar formatChar = FormatChar::jsonChar_default,
                           MidiPrintJsonFormat jsonFormat = MidiPrintJsonFormat::jsonFormat_default) {
        if (formatChar == FormatChar::formatChar_default) {
    ...
    void print_json_pretty(const NotePair& a, size_t index = (size_t)-1, size_t indent = 0,
                           FormatChar formatChar = FormatChar::jsonChar_default,
                           MidiPrintJsonFormat jsonFormat = MidiPrintJsonFormat::jsonFormat_default) {
        if (formatChar == FormatChar::formatChar_default) {
            formatChar = FormatChar::jsonChar_default;
    ...
    void print_json_pretty(const Tempo& a, size_t index = (size_t)-1, size_t indent = 0,
                           FormatChar formatChar = FormatChar::jsonChar_default,
                           MidiPrintJsonFormat jsonFormat = MidiPrintJsonFormat::jsonFormat_default) {
        if (formatChar == FormatChar::formatChar_default) {
            formatChar = FormatChar::jsonChar_default;
    ...
    void print_json_pretty(const BarBeat& a, size_t index = (size_t)-1, size_t indent = 0,
                           FormatChar formatChar = FormatChar::jsonChar_default,
                           MidiPrintJsonFormat jsonFormat = MidiPrintJsonFormat::jsonFormat_default) {
        if (formatChar == FormatChar::formatChar_default) {
            formatChar = FormatChar::jsonChar_default;
    ...
    void print_json_pretty(const Text& a, size_t index = (size_t)-1, size_t indent = 0,
                           FormatChar formatChar = FormatChar::jsonChar_default,
                           MidiPrintJsonFormat jsonFormat = MidiPrintJsonFormat::jsonFormat_default) {
        if (formatChar == FormatChar::formatChar_default) {
            formatChar = FormatChar::jsonChar_default;
        ...
        print_json_pretty_newline(indentStr, indent, "\"%s\":%llu,",
                                  a.timeMode == MidiTimeMode::tick ? "tick" : "microsecond", a.time);
        print_json_pretty_newline(indentStr, indent, "\"type\":\"%s\",", Text::get_typeName(a.type).c_str());
    ...
    void print_json_pretty(const MidiEvent& a, size_t index = (size_t)-1, size_t indent = 0,
                           FormatChar formatChar = FormatChar::jsonChar_default,
                           MidiPrintJsonFormat jsonFormat = MidiPrintJsonFormat::jsonFormat_default) {
        if (formatChar == FormatChar::formatChar_default) {
            formatChar = FormatChar::jsonChar_default;
    ...
    template <typename _MidiEvent>
    void print_json_pretty(const MidiEventList<_MidiEvent>& _list, size_t index = (size_t)-1, size_t indent = 0,
                           FormatChar formatChar = FormatChar::jsonChar_default,
                           MidiPrintJsonFormat jsonFormat = MidiPrintJsonFormat::jsonFormat_default) {
        if (formatChar == FormatChar::formatChar_default) {
            formatChar = FormatChar::jsonChar_default;
        ...
        if (_list.size()) {
            for (size_t i = 0; i < _list.size() - 1; ++i) {
                print_json_pretty(_list[i], i, indent, FormatChar((formatChar & 0x03) | FormatChar::endChar_comma),
                                  MidiPrintJsonFormat(jsonFormat & (~MidiPrintJsonFormat::jsonFormat_file) |
                                                      MidiPrintJsonFormat::jsonFormat_object));
            }
            print_json_pretty(_list.back(), _list.size() - 1, indent,
                              FormatChar((formatChar & 0x03) | FormatChar::endChar_newline),
                              MidiPrintJsonFormat(jsonFormat & (~MidiPrintJsonFormat::jsonFormat_file) |
                                                  MidiPrintJsonFormat::jsonFormat_object));
        }
        --indent;
    ...
    template <typename _MidiEvent>
    void print_json_pretty(const MidiEventMap<_MidiEvent>& _map, size_t index = (size_t)-1, size_t indent = 0,
                           FormatChar formatChar = FormatChar::jsonChar_default,
                           MidiPrintJsonFormat jsonFormat = MidiPrintJsonFormat::jsonFormat_default) {
        if (formatChar == FormatChar::formatChar_default) {
            formatChar = FormatChar::jsonChar_default;
        ...
        if (_map.size()) {
            for (size_t i = 0; i < _map.size() - 1; ++i) {
                print_json_pretty(_map[i], i, indent, FormatChar((formatChar & 0x03) | FormatChar::endChar_comma),
                                  MidiPrintJsonFormat(jsonFormat & (~MidiPrintJsonFormat::jsonFormat_file) |
                                                      MidiPrintJsonFormat::jsonFormat_object));
            }
            print_json_pretty(_map.back(), _map.size() - 1, indent,
                              FormatChar((formatChar & 0x03) | FormatChar::endChar_newline),
                              MidiPrintJsonFormat(jsonFormat & (~MidiPrintJsonFormat::jsonFormat_file) |
                                                  MidiPrintJsonFormat::jsonFormat_object));
        }
    ...
    void print_json_pretty(const MidiParser& _parser, size_t index = (size_t)-1, size_t indent = 0,
                           FormatChar formatChar = FormatChar::jsonChar_default,
                           MidiPrintJsonFormat jsonFormat = MidiPrintJsonFormat::jsonFormat_default) {
        if (formatChar == FormatChar::formatChar_default) {
            formatChar = FormatChar::jsonChar_default;
        ...
        ++indent;
        print_json_pretty(_parser.noteMap, 0, indent, FormatChar((formatChar & 0x03) | FormatChar::endChar_comma),
                          MidiPrintJsonFormat(jsonFormat & (~MidiPrintJsonFormat::jsonFormat_file) |
                                              MidiPrintJsonFormat::jsonFormat_object));
        print_json_pretty(_parser.tempoMap, 1, indent, FormatChar((formatChar & 0x03) | FormatChar::endChar_comma),
                          MidiPrintJsonFormat(jsonFormat & (~MidiPrintJsonFormat::jsonFormat_file) |
                                              MidiPrintJsonFormat::jsonFormat_object));
        print_json_pretty(_parser.bbMap, 2, indent, FormatChar((formatChar & 0x03) | FormatChar::endChar_comma),
                          MidiPrintJsonFormat(jsonFormat & (~MidiPrintJsonFormat::jsonFormat_file) |
                                              MidiPrintJsonFormat::jsonFormat_object));
        print_json_pretty(_parser.textMap, 3, indent, FormatChar((formatChar & 0x03) | FormatChar::endChar_newline),
                          MidiPrintJsonFormat(jsonFormat & (~MidiPrintJsonFormat::jsonFormat_file) |
                                              MidiPrintJsonFormat::jsonFormat_object));
        --indent;
        if (formatChar & FormatChar::endChar_comma) {
